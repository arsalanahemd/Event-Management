...
//     e.preventDefault();
//     const { floor, boothName, boothSize } = formData;
...
//     setLoading(true);
//     try {
//       const res = await axios.post("http://localhost:3001/floors", formData);
//       if (res.data.success) {
//         setAlert({ success: true, message: "Floor added successfully!" });
//         setFormData({ floor: "", boothName: "", boothSize: "" });
//         setTimeout(() => {
//           navigate("/showFloor");
//         }, 1500);
//       } else {
...
//           {[
//             { label: "Floor (e.g. Ground Floor)", name: "floor", type: "text" },
//             { label: "Booth Name", name: "boothName", type: "text" },
//             { label: "Booth Size (e.g. 10x10)", name: "boothSize", type: "text" },
//           ].map((field) => (
//             <TextField
//               key={field.name}
//               fullWidth
    ...
    <div style={{
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "32px", position: "relative" }}>
          ...
          >
            <IconLayers size={32} color={G.gold} />
          </motion.div>
          ...
          <h1 style={{
            ...
            Add{" "}
            <em style={{ fontStyle: "italic", color: G.gold }}>Floor</em>
          </h1>
        </div>

...
/* =============================================
   ICONS (SVG)
   ============================================= */
const IconMic = ({ size = 55, color = G.gold }) => (
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "32px", position: "relative" }}>
          ...
          <h1 style={{
            ...
            Add{" "}
            <em style={{ fontStyle: "italic", color: G.gold }}>Speaker</em>
          </h1>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "24px" }}>
            ...
            >
              <IconUpload size={18} />
              {formData.image ? "Change Image" : "Upload Speaker Image"}
              <input type="file" hidden accept="image/*" onChange={handleImageChange} />
            </label>
            {formData.image && (
              <motion.p
                ...
                style={{
                  marginTop: "8px",
                  fontFamily: "'Inter', sans-serif",
                  fontSize: "12px", color: G.gold, fontWeight: 600,
                  textAlign: "center",
                }}
              >
                Selected: {formData.image.name}
